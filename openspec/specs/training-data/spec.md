...
Captures optional training metrics (distance, session type, notes) after a member signs in. Data is stored on the session record. The screen is always skippable so it never blocks sign-in completion.
