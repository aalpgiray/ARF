  ...
  return (
    <div className="arf-body">
      <div className="empty">
        ...
        <p className="sub">
          {tone === 'friendly'
            ? 'Nobody out right now. Tide turns at 07:18 — be the first one off the jetty.'
    ...
    <div className="arf-body">
      ...
      <div style={{padding:'20px 32px 0', display:'grid', gridTemplateColumns:'1fr 1fr', gap:16}}>
        <div className="card" style={{padding:'20px 24px'}}>
          ...
          <div style={{fontFamily:'var(--serif)', fontStyle:'italic', fontSize:32, lineHeight:1, marginTop:8}}>jetty · 05:30</div>
